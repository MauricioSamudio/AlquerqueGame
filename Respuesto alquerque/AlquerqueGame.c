...
int siLugarEstaOcupado(int K, int L, int sentido){ //Si retorna true es porque se intenta mover una pieza donde ya esta otra, y este intercambio solo se permite antes de iniciar la partida; tambi�n se manda una advertencia.
  ...
  ///////////////////////////////////////////////////////////////////
    ...
    if(sentido == DIAGONAL_DERECHA_ABAJO){
        printf("\nXD233\n");
        if(posicionPiezas[K+1][L+1] != 0){//verificando izquierda
            return true;
        }
    }
...
int siLugarEstaOcupadoSalto(int K,int L,int sentido2){
    ...
    for(i=0;i<12;i++){
        if(jugadorActual == J1){
            if(sentido2 == SALTO_ABAJO){
                if(posicionPiezas[K+1][L] == 0){//verificando abajo
                    return true;
                }if(posicionPiezas[K+1][L] == piezasJ1[i]){
                    return true;
                }
                if(posicionPiezas[K+1][L] == piezasJ2[i] && posicionPiezas[K+2][L] !=0 ){//verificando arriba
                    return true;
                }
                return false;
            }
            if(sentido2 == SALTO_ARRIBA){
                if(posicionPiezas[K-1][L] == 0){//verificando arriba
                    return true;
                }if(posicionPiezas[K-1][L] == piezasJ1[i]){//verificando arriba
                    return true;
                }
                if(posicionPiezas[K-1][L] == piezasJ2[i] && posicionPiezas[K-2][L] !=0 ){//verificando arriba
                    return true;
            ...
            if(sentido2 == SALTO_DERECHA){
                if(posicionPiezas[K][L+1] == 0){//verificando arriba
                    return true;
                }if(posicionPiezas[K][L+1] == piezasJ1[i]){//verificando arriba
                    return true;
                }
                if(posicionPiezas[K][L+1] == piezasJ2[i] && posicionPiezas[K][L+2] !=0 ){//verificando arriba
                    return true;
                }
                return false;
            }
            if(sentido2 == SALTO_IZQUIERDA){
                if(posicionPiezas[K][L-1] == 0){//verificando arriba
                    return true;
                }if(posicionPiezas[K][L-1] == piezasJ1[i]){//verificando arriba
                    return true;
            ...
            if(sentido2 == SALTO_DIAGONAL_DERECHA_ABAJO){
                if(posicionPiezas[K+1][L+1] == 0){//verificando arriba
                    printf("\nDX1\n");
                    return true;
                }if(posicionPiezas[K+1][L+1] == piezasJ1[i]){//verificando arriba
                    printf("\nD2\n");
                    return true;
                }
                if(posicionPiezas[K+1][L+1] == piezasJ2[i] && posicionPiezas[K+1][L+2] !=0 ){//verificando arriba
                    printf("\nDX3\n");
                    return true;
                }
                return false;
            }
            if(sentido2 == SALTO_DIAGONAL_DERECHA_ARRIBA){
                if(posicionPiezas[K-1][L+1] == 0){//verificando arriba
                    return true;
                }if(posicionPiezas[K-1][L+1] == piezasJ1[i]){//verificando arriba
                    return true;
            ...
            if(sentido2 == SALTO_DIAGONAL_IZQUIERDA_ABAJO){
                if(posicionPiezas[K+1][L-1] == 0){//verificando arriba
                    return true;
                }if(posicionPiezas[K+1][L-1] == piezasJ1[i]){//verificando arriba
                    return true;
                }
                if(posicionPiezas[K+1][L-1] == piezasJ2[i] && posicionPiezas[K+1][L-1] !=0 ){//verificando arriba
                    return true;
                }
                return false;
            }
            if(sentido2 == SALTO_DIAGONAL_IZQUIERDA_ARRIBA){
                if(posicionPiezas[K-1][L-1] == 0){//verificando arriba
                    return true;
                }if(posicionPiezas[K-1][L-1] == piezasJ1[i]){//verificando arriba
                    return true;
                    ...
                    for(L = 0; L < 5; L++){
                        if((I == K) && (J == L)){
                            if(siSobrePasaLimites(K-2 , SALTO_ARRIBA)){
                                ...
                                if(siLugarEstaOcupadoSalto(K, L, SALTO_ARRIBA)){
                                    FNmensajeDialogo(formDialogo.Ventana, "\n\n NO PUEDES COLOCAR EN ESA POSICION LA FICHA\n");
                                    printf("\a");
                                }
                                else{
                    ...
                    for(L = 0; L < 5; L++){
                        if((I == K) && (J == L)){
                            if(siSobrePasaLimites(K+2, SALTO_ABAJO)){
                                ...
                                if(siLugarEstaOcupadoSalto(K, L, SALTO_ABAJO)){
                                    FNmensajeDialogo(formDialogo.Ventana, "\nn NO PUEDES COLOCAR EN ESA POSICION LA FICHA\n");
                                    printf("\a");
                                }
                                else{
                    ...
                    for(L = 0; L < 5; L++){
                        if((I == K) && (J == L)){
                            if(siSobrePasaLimites(L+1, SALTO_DERECHA)){
                                ...
                                if(siLugarEstaOcupadoSalto(K, L, SALTO_DERECHA)){
                                    FNmensajeDialogo(formDialogo.Ventana, "\nn NO PUEDES COLOCAR EN ESA POSICION LA FICHA\n");
                                    printf("\a");
                                }
                                else{
                    ...
                    for(L = 0; L < 5; L++){
                        if((I == K) && (J == L)){
                            if(siSobrePasaLimites(L-1, SALTO_IZQUIERDA)){
                                ...
                                if(siLugarEstaOcupadoSalto(K, L, SALTO_IZQUIERDA)){
                                    FNmensajeDialogo(formDialogo.Ventana, "\nn NO PUEDES COLOCAR EN ESA POSICION LA FICHA\n");
                                    printf("\a");
                                }
                                else{
        ...
        for(J = 0; J < 5; J++){
            ...
            if(piezaActual == posicionPiezas[I][J]){
                for(K = 0; K < 5; K++){
                    for(L = 0; L < 5; L++){
                        if((I == K) && (J == L)){
                            if(siSobrePasaLimites(L+1, SALTO_DIAGONAL_DERECHA_ABAJO)){
                                FNmensajeDialogo(formDialogo.Ventana, "\n\n No intentes mover la pieza fuera del trablero!\n");
                                printf("\a");
                            }
                            else{
                                if(siLugarEstaOcupadoSalto(K, L, SALTO_DIAGONAL_DERECHA_ABAJO)){
                                    FNmensajeDialogo(formDialogo.Ventana, "\nn NO PUEDES COLOCAR EN ESA POSICION LA FICHA\n");
                                    printf("\a");
                                }
                                else{
                    ...
                    for(L = 0; L < 5; L++){
                        if((I == K) && (J == L)){
                            if(siSobrePasaLimites(L+1, SALTO_DIAGONAL_DERECHA_ARRIBA)){
                                ...
                                if(siLugarEstaOcupadoSalto(K, L, SALTO_DIAGONAL_DERECHA_ARRIBA)){
                                    FNmensajeDialogo(formDialogo.Ventana, "\nn NO PUEDES COLOCAR EN ESA POSICION LA FICHA\n");
                                    printf("\a");
                                }
                                else{
                    ...
                    for(L = 0; L < 5; L++){
                        if((I == K) && (J == L)){
                            if(siSobrePasaLimites(L+1, SALTO_DIAGONAL_IZQUIERDA_ABAJO)){
                                ...
                                if(siLugarEstaOcupadoSalto(K, L, SALTO_DIAGONAL_IZQUIERDA_ABAJO)){
                                    FNmensajeDialogo(formDialogo.Ventana, "\nn NO PUEDES COLOCAR EN ESA POSICION LA FICHA\n");
                                    printf("\a");
                                }
                                else{
                    ...
                    for(L = 0; L < 5; L++){
                        if((I == K) && (J == L)){
                            if(siSobrePasaLimites(L+1, SALTO_DIAGONAL_IZQUIERDA_ARRIBA)){
                                ...
                                if(siLugarEstaOcupadoSalto(K, L, SALTO_DIAGONAL_IZQUIERDA_ARRIBA)){
                                    FNmensajeDialogo(formDialogo.Ventana, "\nn NO PUEDES COLOCAR EN ESA POSICION LA FICHA\n");
                                    printf("\a");
                                }
                                else{
